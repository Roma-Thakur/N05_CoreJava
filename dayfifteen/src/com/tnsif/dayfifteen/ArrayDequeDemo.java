...
public class ArrayDequeDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Element to be remove is: "+aqueue.peek());
		...
		System.out.println("First element removed: "+aqueue.removeFirst());
		System.out.println("Last element removed: "+aqueue.removeLast());
		System.out.println(aqueue);
